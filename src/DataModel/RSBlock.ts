import { ErrorCorrectLevelType } from "../Model";
import { QRErrorCorrectLevel } from "../Utilities";
...
export default class RSBlock {
  ...
  static getRSBlocks(
    ...
    if (rsBlock === null) {
      throw new Error(
        `Bad RS Block @typeNumber:${typeNumber}/errorCorrectionLevel:${errorCorrectLevel}`
      );
    }
